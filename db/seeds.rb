categories = Category.create!([{ name: 'Hjem og familie' }, { name: 'Ernæring 2' }, { name: 'Helse 1' }])
...
Tutor.create!([{first_name: 'Bjørn', last_name: 'Karlsen', email: 'bjørn@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'CEO'},
							 {first_name: 'Jan', last_name: 'Eriksen', email: 'jan@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'Mindfullness coach'},
							 {first_name: 'Olav', last_name: 'Pettersen', email: 'olav@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'CEO'},
							 {first_name: 'Per', last_name: 'Andersen', email: 'per@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'CEO'},
							 {first_name: 'Leif', last_name: 'Olsen', email: 'leif@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'CEO'},
							 {first_name: 'Tore', last_name: 'Nilsen', email: 'tore@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'Terapeut'},
							 {first_name: 'Tuva', last_name: 'Hansen', email: 'tuva@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'CEO'}, 
							 {first_name: 'Marie', last_name: 'Karlsen', email: 'maria@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'Celebrity'},
							 {first_name: 'Victoria', last_name: 'Eriksen', email: 'victoria@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'CEO'},
							 {first_name: 'Sofia', last_name: 'Pettersen', email: 'sofia@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'Boss'},
							 {first_name: 'Olivia', last_name: 'Andersen', email: 'olivia@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'CEO'},
							 {first_name: 'Ella', last_name: 'Olsen', email: 'ella@gmail.com', password: 'testtest', password_confirmation: 'testtest', admin: true, job_title: 'Rådgiver'},
